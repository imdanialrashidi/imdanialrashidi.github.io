# Historical Pi research — not OMP setup instructions

Preserved from source commit `40d1c630fdea3acbd29dbb1c7a68e3bd2efb0477`. This is a provenance record, not evidence that Pi-specific mechanisms apply to OMP. See [OMP research](RESEARCH.md) and [migration map](MIGRATION.md).

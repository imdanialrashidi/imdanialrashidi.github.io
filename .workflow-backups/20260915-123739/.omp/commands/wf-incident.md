...
4. For security, money, data integrity, migrations, access, or privacy impact, apply `docs/QUALITY.md` and use OMP's bundled `security-reviewer` when an independent read-only pass adds value.
